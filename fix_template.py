                        ...
                        <!-- Status Changer Form -->
                         <form method="post" style="display: flex; gap: 0.5rem;">
                            ...
                            <select name="new_status" onchange="this.form.submit()" 
                                    style="padding: 0.25rem; font-size: 0.8rem; width: auto; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.2);">
...
file_path = os.path.join(os.getcwd(), 'tickets', 'templates', 'tickets', 'admin_panel.html')
