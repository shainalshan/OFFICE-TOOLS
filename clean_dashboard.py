            ...
            <form action="{% url 'configure_backup' %}" method="POST" id="settingsForm">
                ...
                <div class="form-group">
                    <label class="input-label" style="display: flex; justify-content: space-between;">
                        ...
                        <span style="color: white; font-weight: 600;"><span id="retentionVal">{{ config.retention_days
                                }}</span> Days</span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; gap: 1.5rem;">
                        <label
                            ...
                            <input type="checkbox" name="email_notifications" {% if config.email_notifications
                                %}checked{% endif %}> Enable
                        </label>
                        <label
                            style="display: flex; gap: 0.5rem; color: var(--text-secondary); align-items: center; cursor: pointer;">
                            <input type="checkbox" name="email_files_only" {% if config.email_files_only %}checked{%
                                endif %}> Files Only
                        </label>
                    </div>
                </div>
